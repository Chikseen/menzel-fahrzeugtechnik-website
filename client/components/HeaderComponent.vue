<template>
  <div class="">
    <div class="header" @click="testclick">
      ...
      <div
        class="header_quickConntact header_quickConntact_timeing"
        @mouseup="$router.push('/contact')"
      >
      ...
      <div
        :class="['header_nav_menu', menuOpen ? 'header_nav_menu_extendet' : '']"
